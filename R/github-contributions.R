...
#' Count GitHub contributions for current day
#'
#' @param quiet If `FALSE`, print notifications to screen
#' @param ndays Number of preceding days for which contributions should be extracted.
#' @return `data.frame` of calendar dates and contribution counts.
#' @export
gh_contributions <- function (quiet = FALSE, ndays = 5L) {
    ...
    calendar <- calendar [order (calendar$date, decreasing = TRUE), ]
